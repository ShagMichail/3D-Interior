...
protocol GroopVCInput: AnyObject {
    func didReceive(_ product: [Product])
}

final class GroopVC: UIViewController {
    ...
    required init(idRooms: String) {
        self.idRooms = idRooms
...
extension GroopVC: GroopViewDelegate {
...
extension GroopVC: GroopVCInput {
    func didReceive(_ product: [Product]) {
